    ...
    public static void main(String[] args) {
        ...
        for (Kulud kulu : kulud) {
            ...
            if (veelJaotada == 0 && valdkonnaIndeks != 0 || veelJaotada < 0) {
                ...
                if (veelJaotada == 0) {
                    ...
                    System.out.println("Vajuta 2, kui soovid mõnda varasemat eelarvet uuesti sisestada");
        ...
        while (true) {
            ...
            if (valik.equals("1")) {
                ...
                if (eelarvedKokku + /*((double) andmed[8][2])*/ -kuludKokku > 0)
                    System.out.println("Võimalik kulutada veel " + (eelarvedKokku + /*((double) andmed[8][2])*/-kuludKokku) + " eurot");
